...
import prop9 from "../assets/images/prop9.jpg";
...
const Footer = () => {
  ...
  return (
    <>
      ...
      >
        <div className="flex  flex-col justify-center items-start gap-5">
          ...
          <p className="text-slate-200 text-justify">
            ...
            sets us apart in the real estate industry.Join us in shaping a
            future where luxury meets affordability, and dreams turn into
            reality. Welcome to real estate project where your journey to the
            perfect home begins!
          </p>
          <div
            id="social-icons"
            className=" flex justify-start item-center gap-4 mt4"
          >
            ...
            <div className="p-3 rounded-xl bg-white hover:bg-red-600 hover:text-white cursor-pointer transform hover:scale-110 transition-transform duration-300">
            <a
                href="https://www.YouTube.com/YOUR_Facebook_USERNAME"
                target="_blank"
                rel="noopener noreferrer"
               >
        ...
        <div className="flex flex-col justify-center items-start gap-5">
          ...
          <div className=" flex justify-center items-center gap-3">
            ...
            <p className="text-slate-200">+91 1234567890</p>
          </div>
          <div className=" flex justify-center items-center gap-3">
          ...
          <div className=" flex justify-center items-center gap-3">
            ...
            <p className="text-slate-200">realestate.123@gmail.com</p>
          </div>
        </div>
        ...
        <div className=" flex flex-col justify-center items-start gap-5">
          ...
          <div className="flex  justify-center items-start gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400">$ 290.90</p>
            </div>
          </div>
          ...
          <div className="flex justify-center items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400">$ 400.89</p>
            </div>
          </div>
        </div>
      </footer>
      ...
      <div
        id="icon-box"
        className="bg-red-600 p-4 rounded-full hover:bg-black cursor-pointer fixed lg:bottom-12 botoom-6 right-6"
      >
