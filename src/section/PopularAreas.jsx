...
const PopularAreas = () => {
  ...
  return (
    ...
    <div >
      <h1 data-aos="zoom-in" className='text-red-500 dark:text-red'>POPULAR AREAS</h1>
      <h1 data-aos="zoom-in" className={`${darkMode ? 'text-white' : 'text-black' } text-black text-[40px] font-semibold leading-10 mt-4 `} >Explore most <br/>
      popular areas</h1>
      </div>
    ...
    <div data-aos="zoom-in" data-aos-delay="400" style={{ backgroundImage:`url(${area3})`}} className='h-[400px] bg-cover bg-center rounded-xl'></div>
      ...
      <div id='bottom' className='w-full grid lg:grid-cols-3 grid-cols-1 lg:justify-center justify-start items-center gap-6'>
        <div data-aos="slide-up" data-aos-delay="100" className='flex justify-center lg:items-center gap-8 w-full'>
       <h1 className={`${darkMode ? 'text-white' : 'text-black' } text-7xl font-semibold `}>5K</h1>
       <h1 className={`${darkMode ? 'text-white': 'text-black'}`} >ACTIVE <br /> LISTINGS</h1>
        </div>
        <div data-aos="slide-up" data-aos-delay="100" className='flex justify-center lg:items-center gap-8 w-full'>
       <h1 className={`${darkMode ? 'text-white' : 'text-black' } text-7xl font-semibold `}>9K</h1>
       <h1 className={`${darkMode ? 'text-white': 'text-black'}`}>ACTIVE <br /> LISTINGS</h1>
        </div>
        <div data-aos="slide-up" data-aos-delay="100" className='flex justify-center lg:items-center gap-8 w-full'>
       <h1 className={`${darkMode ? 'text-white' : 'text-black' } text-7xl font-semibold `}>6K</h1>
       <h1 className={`${darkMode ? 'text-white': 'text-black'}`}>ACTIVE <br /> LISTINGS</h1>
        </div>
      </div>
      </section>
